...
ICACHE_RODATA_ATTR
extern char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_UPDATE_CURRENT_VERSION[];

ICACHE_RODATA_ATTR
extern char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_UPDATE_NEW_VERSION[];

ICACHE_RODATA_ATTR
extern char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_UPDATE_VERIFICATION_DATA[];

ICACHE_RODATA_ATTR
extern char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_UPDATE_STATUS[];

ICACHE_RODATA_ATTR
extern char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_VALUE_UPDATE_STATUS_FAILED[];

ICACHE_RODATA_ATTR
extern char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_VALUE_UPDATE_STATUS_SUCCEEDED[];

ICACHE_RODATA_ATTR
extern char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_VALUE_UPDATE_STATUS_NONE[];
