...
Datagram_t *ICACHE_FLASH_ATTR DynamicDatagramPoolImpl_datagramPool_newDatagram(size_t length, void *___id)
{
  if (length == 0) 
  {
...
void ICACHE_FLASH_ATTR DynamicDatagramPoolImpl_datagramPool_deleteDatagram(Datagram_t *pDatagram, void *___id)
{
  if (pDatagram == NULL) 
  {
    return;
...
Datagram_t *ICACHE_FLASH_ATTR DynamicDatagramPoolImpl_datagramPool_resizeDatagram(Datagram_t *pDatagram, size_t newLength, void *___id)
{
