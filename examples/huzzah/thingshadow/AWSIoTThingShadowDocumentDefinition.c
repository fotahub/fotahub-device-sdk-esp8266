...
ICACHE_RODATA_ATTR char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_UPDATE_CURRENT_VERSION[] = "currentVersion";

ICACHE_RODATA_ATTR char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_UPDATE_NEW_VERSION[] = "newVersion";

ICACHE_RODATA_ATTR char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_UPDATE_VERIFICATION_DATA[] = "verificationData";

ICACHE_RODATA_ATTR char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_UPDATE_STATUS[] = "updateStatus";

ICACHE_RODATA_ATTR char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_VALUE_UPDATE_STATUS_FAILED[] = "failed";

ICACHE_RODATA_ATTR char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_VALUE_UPDATE_STATUS_SUCCEEDED[] = "succeeded";

ICACHE_RODATA_ATTR char const AWS_IOT_THING_SHADOW_JSON_ATTRIBUTE_VALUE_UPDATE_STATUS_NONE[] = "none";
