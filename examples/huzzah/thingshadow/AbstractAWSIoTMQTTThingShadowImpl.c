...
AWSIoTSessionData_t *ICACHE_FLASH_ATTR AbstractAWSIoTMQTTThingShadowImpl_newAWSIoTData(void *___id)
{
...
bool ICACHE_FLASH_ATTR AbstractAWSIoTMQTTThingShadowImpl_isAWSIoTDataDeleted(AWSIoTSessionData_t *pSessionData, void *___id)
{
...
bool ICACHE_FLASH_ATTR AbstractAWSIoTMQTTThingShadowImpl_thingShadow_update(const void* hSession, char *jsonString, void *___id)
{
  ...
  Datagram_t *mqttPublishMessage = (*___cid->mqttClient__ops->newPublishMessage)(pSessionData->hDownstreamSession, os_strlen(jsonString), ___cid->mqttClient__ops->__instance);
...
void ICACHE_FLASH_ATTR AbstractAWSIoTMQTTThingShadowImpl_timeoutHandler_expired(void *___id)
{
  AbstractAWSIoTMQTTThingShadowImpl__cdata_t *___cid = ((AbstractAWSIoTMQTTThingShadowImpl__cdata_t *) ___id);
  for ( int16_t __i = 0 ; __i < MAX_AWS_IOT_MQTT_REQUEST_COUNT; __i++ )
  {
