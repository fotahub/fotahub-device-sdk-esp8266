...
void ICACHE_FLASH_ATTR AWSIoTThingShadowGateImpl_init(void *___id)
{
...
void ICACHE_FLASH_ATTR AWSIoTThingShadowGateImpl_awsThingShadowEngine__init(awsThingShadowEngine__data_t *instance, void *___id)
{
    ...
    case awsThingShadowEngine_connectedToNetwork__state:
    {
      switch (event)
      {
        case awsThingShadowEngine_epsilon__event:
        {
           ...
           * transition actions
           */
          os_printf("Connecting to AWS IoT Thing Shadow\n");
      ...
      switch (event)
      {
        ...
        case awsThingShadowEngine_thingShadowStatus__event:
        {
          ...
          if (___cid->updateAvailable__field) 
          {
             ...
             * transition actions
             */
            os_printf("Disconnecting from AWS IoT Thing Shadow\n");
...
void ICACHE_FLASH_ATTR AWSIoTThingShadowGateImpl_thingShadowHandler_connectionError(const void* hSession, AWSIoTError_t error, void *___id)
{
  /* 
   * Do nothing
   */
...
bool ICACHE_FLASH_ATTR AWSIoTThingShadowGateImpl_updateThingShadowState(void *___id)
{
  AWSIoTThingShadowGateImpl__cdata_t *___cid = ((AWSIoTThingShadowGateImpl__cdata_t *) ___id);
  /* 
...
bool ICACHE_FLASH_ATTR AWSIoTThingShadowGateImpl_handleThingShadowDelta(char const *jsonString, size_t const jsonStringLength, void *___id)
{
  AWSIoTThingShadowGateImpl__cdata_t *___cid = ((AWSIoTThingShadowGateImpl__cdata_t *) ___id);
  /* 
  ...
  bool result = (*___cid->jsonSerializer__ops->addValue)(hDocument, ((char *)(AWS_IOT_THING_SHADOW_JSON_DESIRED_PATH)), MODE_ALL_ATTRIBUTES, ___cid->jsonSerializer__ops->__instance);
...
void ICACHE_FLASH_ATTR AWSIoTThingShadowGateImpl_evaluateUpdateInfo(void *___id)
{
  AWSIoTThingShadowGateImpl__cdata_t *___cid = ((AWSIoTThingShadowGateImpl__cdata_t *) ___id);
  ___cid->updateAvailable__field = false;
  if (os_strlen(___cid->firmwareUpdateVersionInfo__port->updateVersion) > 0) 
  {
    if (os_strcmp(___cid->firmwareUpdateVersionInfo__port->updateVersion, ((char *)(DEMO_PRODUCT_FIRMWARE_VERSION))) != 0) 
    {
    ...
    {
      os_printf("Ignoring FOTA update request to version %s as this version is already running\n", ___cid->firmwareUpdateVersionInfo__port->updateVersion);
    }
  }
}
...
void ICACHE_FLASH_ATTR AWSIoTThingShadowGateImpl_thingShadowHandler_status(const void* hSession, char const *thingName, AWSIoTThingShadowAction_t action, AWSIoTThingShadowAckStatus_t status, char *jsonString, size_t jsonStringLength, void *___id)
{
  AWSIoTThingShadowGateImpl__cdata_t *___cid = ((AWSIoTThingShadowGateImpl__cdata_t *) ___id);
...
void ICACHE_FLASH_ATTR AWSIoTThingShadowGateImpl_thingShadowHandler_delta(const void* hSession, char const *thingName, char *jsonString, size_t jsonStringLength, void *___id)
{
  AWSIoTThingShadowGateImpl__cdata_t *___cid = ((AWSIoTThingShadowGateImpl__cdata_t *) ___id);
