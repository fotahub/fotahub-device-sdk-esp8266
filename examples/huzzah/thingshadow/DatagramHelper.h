...
static inline Datagram_t *ICACHE_FLASH_ATTR convertToDatagram(void *buffer, size_t bufferSize);

static inline void ICACHE_FLASH_ATTR initDatagram(Datagram_t *pDatagram, void *pPayload, size_t pPayloadLength);

static inline char *ICACHE_FLASH_ATTR getDatagramPayloadAsString(Datagram_t *pDatagram);

static inline void ICACHE_FLASH_ATTR resetDatagram(Datagram_t *pDatagram);
