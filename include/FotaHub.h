...
void ICACHE_FLASH_ATTR fotahub_notifyNetworkStatusChange(enum NetworkAdapterStatus status);

bool ICACHE_FLASH_ATTR fotahub_downloadFirmwareUpdate(FirmwareUpdateInfo_t *pUpdateInfo);

bool ICACHE_FLASH_ATTR fotahub_activateFirmwareUpdate(FirmwareUpdateInfo_t *pUpdateInfo);

bool ICACHE_FLASH_ATTR fotahub_confirmFirmwareUpdate(FirmwareUpdateInfo_t *pUpdateInfo);

bool ICACHE_FLASH_ATTR fotahub_revertFirmwareUpdate(FirmwareUpdateInfo_t *pUpdateInfo);
